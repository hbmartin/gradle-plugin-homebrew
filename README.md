...
[![Use this template](https://img.shields.io/badge/-Use%20this%20template-brightgreen)](https://github.com/cortinico/gradle-plugin-homebrew/generate) [![Pre Merge Checks](https://github.com/cortinico/gradle-plugin-homebrew/workflows/Pre%20Merge%20Checks/badge.svg)](https://github.com/cortinico/gradle-plugin-homebrew/actions?query=workflow%3A%22Pre+Merge+Checks%22)  [![License](https://img.shields.io/github/license/cortinico/kotlin-android-template.svg)](LICENSE) ![Language](https://img.shields.io/github/languages/top/cortinico/kotlin-android-template?color=blue&logo=kotlin)
...
Just click on [![Use this template](https://img.shields.io/badge/-Use%20this%20template-brightgreen)](https://github.com/cortinico/gradle-plugin-homebrew/generate) button to create a new repo starting from this template.

Once created don't forget to update the:
- [gradle.properties](plugin-build/gradle.properties)
- Plugin Usages (search for [me.haroldmartin.homebrew](https://github.com/cortinico/gradle-plugin-homebrew/search?q=me.haroldmartin.homebrew&unscoped_q=me.haroldmartin.homebrew) in the repo and replace it with your ID).
...
The [![Publish Plugin to Portal](https://github.com/cortinico/gradle-plugin-homebrew/workflows/Publish%20Plugin%20to%20Portal/badge.svg?branch=1.0.0)](https://github.com/cortinico/gradle-plugin-homebrew/actions?query=workflow%3A%22Publish+Plugin+to+Portal%22) Github Action will take care of the publishing whenever you **push a tag**.
